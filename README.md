...
| Method       | Level | Orig(MB) | Comp(MB) | Ratio  | Enc(ms) | Dec(ms) | Enc (GB/s) | Dec (GB/s) |
| ------------ | ----- | -------- | -------- | ------ | ------- | ------- | ---------- | ---------- |
| Pure-ZSTD    | 3     | 36.00    | 28.13    | 1.2797 | 70.169  | 81.861  | 0.538      | 0.461      |
| Pure-ZSTD    | 5     | 36.00    | 28.13    | 1.2798 | 365.595 | 80.768  | 0.103      | 0.467      |
